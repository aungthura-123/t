        ...
        if message.new_chat_members:
            ...
            for user in message.new_chat_members:
                try:
                    ...
                    if user.id == bot_id:
                        msg = "<tg-emoji emoji-id='5251299553239398548'>🤖</tg-emoji> <b> Nᴏ Pʟᴀɴ B Bot Active!</b>\n\n<tg-emoji emoji-id='5215613971352004352'>❤️</tg-emoji> ဘေဘီ ကို Admin ပေးထားဖို့ မမေ့ပါနဲ့ရှင့်။ <tg-emoji emoji-id='5215361191051798408'>🤍</tg-emoji>\n\nSpam link တွေနဲ့ Bio တွေကို အလိုအလျောက် ဖျက်ပေးပါ့မယ်။",
                        reply_markup=main_buttons()
